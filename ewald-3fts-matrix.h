 ...
 */
void
trans_normal (int np, const double *r, double *res_matrix);


void
calc_res_3fts_matrix (struct stokes * sys, double *matrix);

void
calc_mob_3fts_matrix (struct stokes * sys, double *mov_matrix);
